...
public class ServerStartup {
    ...
    public void configureServer(){
        ...
        this.app.error(404, ctx ->{
            ctx.redirect("https://s3.us-east-2.amazonaws.com/www.heropayproject1.com/404.html");
        });

        this.app.error(401, ctx ->{
            ctx.redirect("https://s3.us-east-2.amazonaws.com/www.heropayproject1.com/401.html");
        });
